...
/** Tests if the enemyMovesForward() met works correctly with different coordinates and Enemy rank types 
...
class EnemyTest {
    ...
    void enemyRank1MovesForwardShouldMoveX0Y0() {
        ...
        testEnemy.enemyMovesForward(new Coordinate(shouldBeCordX, shouldBeCordY), endingPoint);   
    ...
    // moves by X1 Y1
    @Test
    @DisplayName("Testing if the Enemy (rank 1) after moving x 1 and y 1 has the right coordinates")
    ...
    @Test
    @DisplayName("Testing if the circle of Enemy (rank 1) after moving x 1 and y 1 has the right coordinates")
    ...
    @Test
    @DisplayName("Testing if the text of Enemy (rank 1) after moving x 1 and y 1 has the right coordinates")
    ...
    // moves by X10 Y10
    @Test
    @DisplayName("Testing if the Enemy (rank 1) after moving x 10 and y 10 has the right coordinates")
    ...
    @Test
    @DisplayName("Testing if the circle of Enemy (rank 1) after moving x 10 and y 10 has the right coordinates")
    ...
    @Test
    @DisplayName("Testing if the text of Enemy (rank 1) after moving x 10 and y 10 has the right coordinates")
